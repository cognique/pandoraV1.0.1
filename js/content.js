...
var renderHTML = {
    ...
    renderScoreSharePage : function() {
        ...
        var html =
            '<section class="skill-level-page">' +
            '<div class="content skill-level">' +
            '<a href="#" onclick="renderHTML.childBrowserFunction()" class="big-button skill-level">childbrowser</a>' +
            '<a href="#" onclick="window.open(\'' + twitter_url + '\', \'_blank\', \'location=no, menubar=no, resizable=no, scrollbars=no, status=no, titlebar=no, toolbar=no\')" class="big-button skill-level">TWITTER</a>' +
